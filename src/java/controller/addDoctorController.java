...
public class addDoctorController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String query = "INSERT INTO doctor(name, staffID, email, phone, specialties, qualification, image, status) VALUES(?,?,?,?,?,?,?,?)";
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/admin_doctor_list.jsp?msg=added");
